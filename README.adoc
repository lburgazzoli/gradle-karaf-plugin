...
image:https://badges.gitter.im/gradle-karaf-plugin/Lobby.svg[link="https://gitter.im/gradle-karaf-plugin/Lobby?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge"]
