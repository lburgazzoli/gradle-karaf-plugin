= gradle-karaf-plugin
[![Build Status](https://travis-ci.org/lburgazzoli/gradle-karaf-plugin.svg)](https://travis-ci.org/lburgazzoli/gradle-karaf-plugin)
[![Maven Central](https://maven-badges.herokuapp.com/maven-central/com.github.lburgazzoli/gradle-karaf-plugin/badge.svg)](https://maven-badges.herokuapp.com/maven-central/com.github.lburgazzoli/gradle-karaf-plugin)
